<?php
    ...
    // SQL query to get image picture id
    $query = "SELECT * FROM food WHERE food_id = $foodId";
    $result = mysqli_query($connect, $query);
    $row = mysqli_fetch_assoc($result);

    // Variable to store image picture ID
    ...
    // Variable to store the current img picture name and id
        ...
        if(!empty($_FILES["file"]["name"])){
            ...
            if(in_array($fileType, $allowTypes)){
                ...
                if($compressedImage) {
                    ...
                    $query = "UPDATE food SET food_img_id = $pic_id WHERE food_id = $foodId";
                    $result = mysqli_query($connect, $query);
