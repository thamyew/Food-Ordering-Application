<?php
    ...
    $statusCode = 404;
    $statusMsg = "Order failed to reject";
    ...
    if ($row['order_status'] == 0 || $row['order_status'] == 1) {
        ...
        $archiveQuery = "UPDATE food_order SET order_status = 5, order_archived = 1, order_archived_expiry_date = '$expDate' WHERE order_id = $orderId";
        ...
        $statusCode = 200;
        $statusMsg = "Order rejected successfully";
    }
